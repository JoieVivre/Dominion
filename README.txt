...
There is some error checking for user input: if you're actually interested in finishing a game, be careful on how you answer input questions.
Currently, there is minimal error checking for cheating.

...
The game is currently only coded for "First Game" of Dominion: it does not yet include the "Militia" Kingdom deck. The Supply for this game only includes 9 Kingdom decks with only 8 cards each (as opposed to regular 10). Descriptions of the Action cards are 
not provided until after a card is played.
